      ...
      <div className="flex flex-wrap justify-start gap-8">
        <Card className="flex-1">
          <CardHeader>
            ...
            <CardDescription>Enter your character information</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form>
            ...
            <Table className="overflow-hidden rounded-md">
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="w-8 text-center">modifiers</TableHead>
                  <TableHead className="w-8 text-center">total</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <TableRow>
                  <TableCell skin="neutral">{charSpeed.base}</TableCell>
                  <TableCell skin="neutral">{charSpeed.modifiers}</TableCell>
                  <TableCell skin="neutral">
